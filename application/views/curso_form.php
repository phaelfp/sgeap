<div class="container" role="main">
	...
	<div class="row">
		<form action="<?=$action?>" method="post" <?php if(empty($form_name)): ?> name="form1" <?php else: ?> name="<?=$form_name?>" <?php endif; ?> class="form-horizontal">
			<input type="hidden" name="id" value="<?php if (!empty($curso)): echo $curso->id; endif;?>">
			<div class="form-group">
				<label for="descricao" class="col-sm-2 control-label">
					Curso
				</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="descricao" id="descricao" value="<?php if (!empty($curso)): echo $curso->descricao; endif;?>">
				</div>
			</div>
			<div class="form-group">
