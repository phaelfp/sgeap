<div class="container" role="main">
				...
				<td>
					...
					<div class="btn-group visible-xs-block">
					  ...
					  <ul class="dropdown-menu">
					    <li><a href="<?php echo base_url();?>index.php/certificacao/edit/<?php echo $item->id ;?>">Editar</a></li>
	...
	<nav>
	  <ul class="pagination">
	    <li>
		<a href="<?php echo base_url();?>index.php/certificacao/index/<?php echo $page-1;?>" aria-label="Previous">
	        <span aria-hidden="true">&laquo;</span>
	      </a>
		</li>
		<?php for($i=0;$i<$pages;$i++): ?>
		<li><a href="<?php echo base_url() ?>index.php/certificacao/index/<?php echo $i+1 ?>"><?php echo $i+1 ?></a></li>
		<?php endfor; ?>
	    <li>
		  <a href="<?php echo base_url();?>index.php/certificacao/index/<?php echo $page+1;?>" aria-label="Next">
