<div class="container" role="main">
	...
	<nav>
	  <ul class="pagination">
	    <li>
			<a href="<?php echo base_url();?>index.php/disciplina/index/<?php echo $page-1;?>" aria-label="Previous">
	        <span aria-hidden="true">&laquo;</span>
	      </a>
		</li>
		<?php for($i=0;$i<$pages;$i++): ?>
		<li><a href="<?php echo base_url() ?>index.php/disciplina/index/<?php echo $i+1 ?>"><?php echo $i+1 ?></a></li>
		<?php endfor; ?>
	    <li>
		  <a href="<?php echo base_url();?>index.php/disciplina/index/<?php echo $page+1;?>" aria-label="Next">
